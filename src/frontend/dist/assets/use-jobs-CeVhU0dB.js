...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, k as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, l as lookupResultToBuffer, m as RequestStatusResponseStatus, U as UnknownError, n as RequestStatusDoneNoReplyErrorCode, o as RejectError, p as CertifiedRejectErrorCode, q as UNREACHABLE_ERROR, I as InputError, s as InvalidReadStateRequestErrorCode, t as ReadRequestType, v as Principal, w as IDL, x as MissingCanisterIdErrorCode, y as HttpAgent, z as encode, Q as QueryResponseStatus, A as UncertifiedRejectErrorCode, D as isV3ResponseBody, G as isV2ResponseBody, J as UncertifiedRejectUpdateErrorCode, K as UnexpectedErrorCode, L as decode, S as Subscribable, N as pendingThenable, O as resolveEnabled, V as shallowEqualObjects, W as resolveStaleTime, X as noop$1, Y as environmentManager, Z as isValidTimeout, _ as timeUntilStale, $ as timeoutManager, a0 as focusManager, a1 as fetchState, a2 as replaceData, a3 as notifyManager, a4 as hashKey, a5 as getDefaultState, r as reactExports, a6 as shouldThrowError, d as useQueryClient, a7 as useInternetIdentity, a8 as createActorWithConfig, c as createLucideIcon, j as jsxRuntimeExports, a9 as Record, aa as Opt, ab as Vec, ac as Variant, ad as Service, ae as Func, af as Text, ag as Nat, ah as Nat8, ai as Null, aj as Bool, ak as Int, al as Principal$1, f as React, am as composeRefs$1, an as reactDomExports } from "./index-CNOTwOpB.js";
...
Service({
  ...
  "createJob": Func([ExternalBlob$1, Text, Nat], [JobId], []),
  "deleteJob": Func([JobId], [Bool], []),
  "getConfig": Func([], [Config], ["query"]),
  "getJob": Func([JobId], [Opt(Job)], ["query"]),
  "listJobs": Func(
    [Opt(JobStatus$1), Nat, Nat],
    [JobListResult],
    ["query"]
  ),
  "pollReplicateJob": Func([JobId], [], []),
  "setReplicateApiKey": Func([Text], [], []),
  "transform": Func(
    [TransformationInput],
  ...
  "updateJobStatus": Func(
    [JobId, JobStatus$1, Opt(Text), Opt(Text)],
    [],
    []
  )
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const Config2 = IDL2.Record({
    "modelVersion": IDL2.Text,
    "modelId": IDL2.Text
  });
  ...
  const Job2 = IDL2.Record({
    "id": JobId2,
    "status": JobStatus2,
    "inputImageUrl": IDL2.Text,
    "inputImage": ExternalBlob2,
    "userId": UserId2,
    "createdAt": Timestamp2,
    "replicateId": IDL2.Opt(IDL2.Text),
    "motionIntensity": IDL2.Nat,
    "updatedAt": Timestamp2,
    "outputVideoUrl": IDL2.Opt(IDL2.Text),
    "errorMsg": IDL2.Opt(IDL2.Text)
  });
  const JobListResult2 = IDL2.Record({
    "total": IDL2.Nat,
    "jobs": IDL2.Vec(Job2)
  });
  ...
  return IDL2.Service({
    ...
    "createJob": IDL2.Func([ExternalBlob2, IDL2.Text, IDL2.Nat], [JobId2], []),
    "deleteJob": IDL2.Func([JobId2], [IDL2.Bool], []),
    "getConfig": IDL2.Func([], [Config2], ["query"]),
    "getJob": IDL2.Func([JobId2], [IDL2.Opt(Job2)], ["query"]),
    "listJobs": IDL2.Func(
      [IDL2.Opt(JobStatus2), IDL2.Nat, IDL2.Nat],
      [JobListResult2],
      ["query"]
    ),
    "pollReplicateJob": IDL2.Func([JobId2], [], []),
    "setReplicateApiKey": IDL2.Func([IDL2.Text], [], []),
    "transform": IDL2.Func(
      [TransformationInput2],
      [TransformationOutput2],
      ["query"]
    ),
    "updateJobStatus": IDL2.Func(
      [JobId2, JobStatus2, IDL2.Opt(IDL2.Text), IDL2.Opt(IDL2.Text)],
      [],
      []
    )
  });
...
class Backend {
  ...
  async createJob(arg0, arg1, arg2) {
    if (this.processError) {
      try {
        const result = await this.actor.createJob(await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg0), arg1, arg2);
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async listJobs(arg0, arg1, arg2) {
    if (this.processError) {
      try {
        const result = await this.actor.listJobs(to_candid_opt_n16(this._uploadFile, this._downloadFile, arg0), arg1, arg2);
        return from_candid_JobListResult_n19(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
      }
  ...
  async pollReplicateJob(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.pollReplicateJob(arg0);
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async setReplicateApiKey(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.setReplicateApiKey(arg0);
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async updateJobStatus(arg0, arg1, arg2, arg3) {
    if (this.processError) {
      try {
        const result = await this.actor.updateJobStatus(arg0, to_candid_JobStatus_n17(this._uploadFile, this._downloadFile, arg1), to_candid_opt_n22(this._uploadFile, this._downloadFile, arg2), to_candid_opt_n22(this._uploadFile, this._downloadFile, arg3));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
...
async function from_candid_JobListResult_n19(_uploadFile, _downloadFile, value) {
  return await from_candid_record_n20(_uploadFile, _downloadFile, value);
}
function from_candid_JobStatus_n12(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n13(_uploadFile, _downloadFile, value);
}
async function from_candid_Job_n10(_uploadFile, _downloadFile, value) {
...
async function from_candid_opt_n9(_uploadFile, _downloadFile, value) {
  return value.length === 0 ? null : await from_candid_Job_n10(_uploadFile, _downloadFile, value[0]);
}
async function from_candid_record_n11(_uploadFile, _downloadFile, value) {
  return {
    id: value.id,
    status: from_candid_JobStatus_n12(_uploadFile, _downloadFile, value.status),
    inputImageUrl: value.inputImageUrl,
    inputImage: await from_candid_ExternalBlob_n14(_uploadFile, _downloadFile, value.inputImage),
    userId: value.userId,
    createdAt: value.createdAt,
    replicateId: record_opt_to_undefined(from_candid_opt_n15(_uploadFile, _downloadFile, value.replicateId)),
    motionIntensity: value.motionIntensity,
    updatedAt: value.updatedAt,
    outputVideoUrl: record_opt_to_undefined(from_candid_opt_n15(_uploadFile, _downloadFile, value.outputVideoUrl)),
...
async function from_candid_record_n20(_uploadFile, _downloadFile, value) {
  return {
    total: value.total,
    jobs: await from_candid_vec_n21(_uploadFile, _downloadFile, value.jobs)
  };
}
...
function from_candid_variant_n13(_uploadFile, _downloadFile, value) {
  return "completed" in value ? "completed" : "queued" in value ? "queued" : "processing" in value ? "processing" : "failed" in value ? "failed" : value;
}
async function from_candid_vec_n21(_uploadFile, _downloadFile, value) {
  return await Promise.all(value.map(async (x) => await from_candid_Job_n10(_uploadFile, _downloadFile, x)));
}
async function to_candid_ExternalBlob_n8(_uploadFile, _downloadFile, value) {
  return await _uploadFile(value);
}
function to_candid_JobStatus_n17(_uploadFile, _downloadFile, value) {
...
function to_candid_opt_n16(_uploadFile, _downloadFile, value) {
  return value === null ? candid_none() : candid_some(to_candid_JobStatus_n17(_uploadFile, _downloadFile, value));
}
...
const JOB_QUERY_KEY = "jobs";
function useJobs(filter2 = null, limit = 50, offset = 0) {
  const { backend, isReady } = useBackend();
  return useQuery({
    queryKey: [JOB_QUERY_KEY, filter2, limit, offset],
    queryFn: async () => {
      if (!backend) return { jobs: [], total: BigInt(0) };
      return backend.listJobs(filter2, BigInt(limit), BigInt(offset));
    },
    enabled: isReady,
