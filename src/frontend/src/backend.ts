...
import type { ExternalBlob as _ExternalBlob, Job as _Job, JobId as _JobId, JobListResult as _JobListResult, JobStatus as _JobStatus, Timestamp as _Timestamp, UserId as _UserId, _ImmutableObjectStorageRefillInformation as __ImmutableObjectStorageRefillInformation, _ImmutableObjectStorageRefillResult as __ImmutableObjectStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createJob(arg0: ExternalBlob, arg1: string, arg2: bigint): Promise<JobId> {
        if (this.processError) {
            try {
    ...
    async listJobs(arg0: JobStatus | null, arg1: bigint, arg2: bigint): Promise<JobListResult> {
        if (this.processError) {
            try {
    ...
    async pollReplicateJob(arg0: JobId): Promise<void> {
        if (this.processError) {
            try {
    ...
    async setReplicateApiKey(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateJobStatus(arg0: JobId, arg1: JobStatus, arg2: string | null, arg3: string | null): Promise<void> {
        if (this.processError) {
            try {
...
async function from_candid_JobListResult_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _JobListResult): Promise<JobListResult> {
    return await from_candid_record_n20(_uploadFile, _downloadFile, value);
}
function from_candid_JobStatus_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _JobStatus): JobStatus {
    return from_candid_variant_n13(_uploadFile, _downloadFile, value);
}
async function from_candid_Job_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Job): Promise<Job> {
...
async function from_candid_opt_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Job]): Promise<Job | null> {
...
function from_candid_variant_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "completed" in value ? JobStatus.completed : "queued" in value ? JobStatus.queued : "processing" in value ? JobStatus.processing : "failed" in value ? JobStatus.failed : value;
}
async function from_candid_vec_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Job>): Promise<Array<Job>> {
...
function to_candid_JobStatus_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: JobStatus): _JobStatus {
...
function to_candid_opt_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: JobStatus | null): [] | [_JobStatus] {
...
function to_candid_variant_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: JobStatus): {
    completed: null;
} | {
    queued: null;
} | {
    ...
    return value == JobStatus.completed ? {
        completed: null
